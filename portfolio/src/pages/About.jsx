...
const Welcome = () => {
  return (
    <section id="about" className="grid grid-cols-1 md:grid-cols-2 gap-8 p-8"> {/* Grid layout for responsiveness */}
      <img
      ...
      <div className="homeText flex flex-col justify-center text-left"> {/* Flexbox for text alignment */}
        ...
        <p className="text-lg"> {/* Tailwind classes for paragraph */}
          My name is Justin Garvida and I'm currently a student at Drexel University pursuing a Bachelors of Science in Software Engineering and a minor in Data Science! <br/><br/>
